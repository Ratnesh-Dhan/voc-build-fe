...
const Controller = ({
  ...
  return (
    <div className="flex flex-row w-full justify-center items-center ">
      <button
        className="text-white font-semibold text-sm bg-[#20C997] transition duration-200 ease-out hover:scale-110 rounded-full px-3 py-1 mr-2"
        onClick={handlePlay}
      >
      ...
      <TriangleLeftFill
        className="cursor-pointer hover:scale-125 transition duration-200 ease-out"
        strokeWidth={2}
        size={36}
        color="black"
